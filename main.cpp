...
void menu()
{
	...
	cout << "\t\t\t___________________________MENU___________________________________\n\n\n";
	cout << endl;
	cout << endl;
	...
	default:
		system("cls");
		cout << "\t\t\t Please Select a number from given Option";
	}
}
void login()
{
...
{
	int subjectNums;
	string courseId, courseName, rollno;
	system("cls");
	cout << "\t\t\t Enter how many subjects you will do? ";
	cin >> subjectNums;
	while (subjectNums--)
	{
		cout << "\t\t\t Please enter the course Id and Course Name with your roll number: " << endl;
		cout << "\t\t\t Course ID:";
		cin >> courseId;
		cout << "\t\t\t Course Name:";
		cin >> courseName;
